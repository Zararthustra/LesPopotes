  ...
  return (
    <main className="privacyPolicy">
      ...
      <ul>
        ...
        <li>
          <p><strong>Website</strong> refers to Les popotes, accessible from <a href="https://lespopotes.arthurmayer.fr" rel="external nofollow noopener" target="_blank">https://lespopotes.arthurmayer.fr</a></p>
        </li>
        <li>
