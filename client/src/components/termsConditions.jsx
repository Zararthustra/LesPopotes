export const TermsConditions = () => {
  return (
    <main className="privacyPolicy">
      ...
      <p>Last updated: April 23, 2022</p>
      ...
      <ul>
        ...
        <li>
          <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Les popotes.</p>
        </li>
        <li>
        ...
        <li>
          <p><strong>Website</strong> refers to Les popotes, accessible from <a href="https://lespopotes.arthurmayer.fr" rel="external nofollow noopener noreferrer" target="_blank">https://lespopotes.arthurmayer.fr</a></p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: arthmayer@outlook.fr</li>
      </ul>
    </main>
  )
};
