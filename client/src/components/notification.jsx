...
export const Notification = ({ notification }) => {
  ...
  const redirectNotif = () => {
    ...
    else if (notification.type === "thread" || notification.type === "welcome")
  ...
  const notifMessage = (type) => {
    switch (type) {
      ...
      case 'welcome': return (<div>Bienvenue chez les popotes ! Venez vous présenter dans le <b>forum</b> !</div>)
